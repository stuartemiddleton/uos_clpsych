...
def get_data_representation(data):
    getter = PostGetter(data)
    sentences = getter.sentences
...
XX, y, y2 = get_data_representation(data)
...
if save_model=='1':
    ...
    with open("model/model_multitask-sentence-transformer-130-"+model_type+".json", "w") as json_file:
        json_file.write(model_json)
    model.save_weights("model/model_multitask-sentence-transformer-130-"+model_type+".h5")
